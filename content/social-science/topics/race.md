...
In South Africa, the Population Registration Act, 1950 recognized only White, Black, and Coloured, with Indians added later. The government of Myanmar recognizes eight "major national ethnic races." The Brazilian census classifies people into brancos (Whites), pardos (multiracial), pretos (Blacks), amarelos (Asians), and indigenous (see Race and ethnicity in Brazil), though many people use different terms to identify themselves. Legal definitions of whiteness in the United States used before the civil rights movement were often challenged for specific groups.
